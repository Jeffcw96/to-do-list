...
function getAuthorApplication(inputData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                result = yield author_1.default.findOne(getAuthorQuery);
                if (!result) {
                    return new common_1.RecordNotFoundException();
                }
            }
            catch (error) {
...
exports.default = getAuthorApplication;
