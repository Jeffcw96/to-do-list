...
function getBookListApplication(inputData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                result = yield book_1.default.findOne(getBookListQuery);
            }
            catch (error) {
                throw new book_2.FailToGetBookException();
            }
            return result;
        }
        catch (error) {
...
exports.default = getBookListApplication;
