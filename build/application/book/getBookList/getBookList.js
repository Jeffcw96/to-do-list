...
function getBookApplication(inputData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                result = yield book_1.default.find(getBookListQuery);
            }
            catch (error) {
                throw new book_2.FailToGetBookListException();
            }
            return result;
        }
        catch (error) {
...
exports.default = getBookApplication;
